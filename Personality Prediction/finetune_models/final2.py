#implementation using Keras only library (error of model loading soln)
...
def training(inputs, full_targets, trait_labels):
    """ Train MLP model for each trait on 10-fold corss-validtion. """
        ...
        for trait_idx in range(full_targets.shape[1]):
            ...
            model.add(keras.layers.Dense(50, activation='relu', input_dim=features_dim))
            ...
            #model.save('model2k'+str(trait_idx)+'.h5')
            print('model saved')
...
if __name__ == "__main__":
    ...
    n_classes = 2
    #features_dim = 123 or  44(doubt 44 error came latest)
    features_dim = 47
